...
exports.VapidParser = ( function () {
    var bconcat = Buffer.concat
        ...
        , emitError = function ( ccode ) {
            var me = this
                ...
                , msg = 'VapidParser parser error, current char: %s (code: %d), pos: %d.'
        ...
        // VapidParser Parser
        , VapidParser = function ( opt ) {
            var me = this
                , is = me instanceof VapidParser
                ;
            if ( ! is ) return new VapidParser( opt );
            me.options = improve( clone( opt ), vapid_parser_opt );
            me.cdata = null;
            me.cpos = 0;
            me.crule = null;
            me.mchk = false;
    ...
    util.inherits( VapidParser, emitter );

    bproto = VapidParser.prototype;
